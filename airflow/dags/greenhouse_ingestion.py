"""Scheduled Greenhouse job ingestion.
...
from job_ingestion.greenhouse import ingest_greenhouse
...
@dag(
    ...
    description="Fetch Greenhouse postings into the canonical job catalog",
    schedule=SCHEDULE,
...
def greenhouse_ingestion() -> None:
    ...
    def ingest() -> dict[str, int | str]:
        ...
        """
        summary = asyncio.run(ingest_greenhouse(max_records=MAX_RECORDS))
        return {
