...
# The published terms allow 250 hits a day (checked 2026-09-15). The weekly
# and monthly ceilings, 1,000 and 2,500, are looser per day than this one, so
# this is the binding limit.
DAILY_QUOTA = Quota(per_day=250)
